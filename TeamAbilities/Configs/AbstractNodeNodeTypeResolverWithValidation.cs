// -----------------------------------------------------------------------
// <copyright file="AbstractNodeNodeTypeResolverWithValidation.cs" company="Build">
...
namespace TeamAbilities.Configs
{
    ...
    public class AbstractNodeNodeTypeResolverWithValidation : INodeDeserializer
    {
        ...
        public AbstractNodeNodeTypeResolverWithValidation(INodeDeserializer original, params ITypeDiscriminator[] discriminators)
        {
            _original = original;
